...
import { buildKakaoDirectionsUrl, buildKakaoDirectionsUrlToCoordinate } from "./kakao-directions";
...
describe("Kakao directions", () => {
  ...
  it("opens a server-resolved route coordinate without waiting for the school snapshot", () => {
    expect(buildKakaoDirectionsUrlToCoordinate("대전온누리초등학교", 36.35, 127.38))
      .toBe("https://map.kakao.com/link/to/%EB%8C%80%EC%A0%84%EC%98%A8%EB%88%84%EB%A6%AC%EC%B4%88%EB%93%B1%ED%95%99%EA%B5%90,36.35,127.38");
  });
});
